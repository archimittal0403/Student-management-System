...
<li class="nav-item has-treeview">
         ...
         Manage Account
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>AdminLTE-3.05/student/admin/period.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>period</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=$site_url?>AdminLTE-3.05/student/admin/timetable.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Time Table</p>
                </a>
              </li>
...
<li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>
               ...
               <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>AdminLTE-3.05/student/admin/attendance.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Attendance</p>
                </a>
              </li>
     ...
     <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>AdminLTE-3.05/student/admin/fee-details.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fee Details</p>
                </a>
              </li>
          ...
          <!-- //intership -->
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>AdminLTE-3.05/student/admin/study.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Study material</p>
                </a>
              </li>
...
<!-- student Dashboard -->
 ...
 <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=$site_url?>AdminLTE-3.05/student/admin/student-profile.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Student Profile</p>
                </a>
              </li>
